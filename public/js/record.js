...
$(document).ready(function() {
  ...
  var rewards = [
    { //T1
      capture: [0, 106, 1, 2, 5, 24, 38, 42],
      defense: {
        rotA: [0, 106, 1, 2],
        rotB: [0, 106, 1, 2],
        rotC: [0, 106, 1, 2, 39, 48, 49, 104]
      },
      exterminate: [0, 106, 1, 2, 10, 70, 74],
      mobiledefense: [0, 106, 1, 2, 3, 10, 102],
      sabotage: [0, 106, 1, 2, 18, 19, 20, 39, 72, 93],
      survival: {
        rotA: [1, 2, 19, 53, 105],
        rotB: [1, 2, 105],
        rotC: [0, 106, 1, 2, 18, 20, 26, 27, 72, 87, 105]
      },
    },
    { //T2
      capture: [0, 106, 2, 22, 25, 65, 66, 79, 85],
      defense: {
        rotA: [0, 106, 1, 2, 28, 65, 105],
        rotB: [0, 106, 1, 2, 18, 23, 105],
        rotC: [0, 106, 1, 2, 14, 26, 58, 60, 63, 105]
      },
      exterminate: [0, 106, 2, 57, 64, 73, 78, 83, 104],
      mobiledefense: [0, 106, 2, 11, 47, 52, 69, 98, 102],
      sabotage: [0, 106, 2, 22, 34, 38, 75, 85, 98],
      survival: {
        rotA: [0, 106, 1, 2, 27, 32, 105],
        rotB: [0, 106, 1, 2, 20, 37, 59, 105],
        rotC: [0, 106, 1, 2, 17, 23, 30, 51, 67, 91, 105]
      }
    },
    { //T3
      capture: [0, 106, 2, 16, 33, 35, 36, 41, 81],
      defense: {
      ...
      mobiledefense: [0, 106, 2, 3, 4, 7, 67, 71, 80],
      sabotage: [0, 106, 2, 21, 43, 50, 62, 71, 92],
      survival: {
        rotA: [0, 106, 2, 21, 59, 78, 105],
        rotB: [0, 106, 2, 41, 56, 69, 105],
        rotC: [0, 106, 2, 43, 45, 82, 92, 95, 103, 105]
      }
    },
    { //T4
      capture: [0, 106, 2, 33, 36, 81, 100],
      defense: {
      ...
      mobiledefense: [0, 106, 2, 4, 7, 68, 80],
      sabotage: [0, 106, 2, 55, 63, 68, 86, 90, 94, 100],
      survival: {
        rotA: [0, 106, 2, 6, 53, 105],
        rotB: [0, 106, 2, 82, 103, 105],
        rotC: [0, 106, 2, 7, 46, 79, 84, 86, 90, 105]
      }
    }
  ];
