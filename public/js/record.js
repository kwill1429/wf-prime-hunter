  ...
  var rewards = [
    { //T1
      ...
      defense: {
        rotA: [0, 105, 106, 1, 2],
        rotB: [0, 105, 106, 1, 2],
        rotC: [0, 105, 106, 1, 2, 39, 49, 104, 48]
      },
    ...
    { //T2
      capture: [0, 106, 2, 97, 65, 66, 25, 79, 85],
      defense: {
        rotA: [0, 106, 1, 2, 28, 65, 105],
        rotB: [0, 106, 1, 2, 18, 23, 105],
        rotC: [0, 106, 1, 2, 14, 60, 63, 26, 58, 105]
      },
      exterminate: [0, 106, 2, 57, 78, 93, 64, 101, 73],
    ...
    { //T3
      capture: [0, 106, 2, 33, 35, 36, 16, 41, 45],
      defense: {
        rotA: [0, 106, 1, 2, 49, 105],
        rotB: [0, 106, 1, 2, 40, 25, 15, 105],
        rotC: [0, 106, 1, 2, 12, 13, 14, 50, 89, 105]
      },
      exterminate: [0, 106, 2, 8, 44, 31, 89, 91, 99, 101],
